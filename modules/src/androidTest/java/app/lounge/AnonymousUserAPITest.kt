...
class AnonymousUserAPITest {
    ...
    private val testAnonymousAPI = AnonymousAPI.create(
        baseURL = AnonymousAPI.tokenBaseURL
    )

    private val userAgent: String = "{\"package\":\"foundation.e.apps.debug\",\"version\":\"2.5.5.debug\",\"device\":\"coral\",\"api\":32,\"os_version\":\"1.11-s-20230511288805-dev-coral\",\"build_id\":\"319e25cd.20230630224839\"}"
    ...
    @Test
    fun testAPI() {
        testAnonymousAPI.requestAuthData(
